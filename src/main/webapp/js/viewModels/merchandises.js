...
define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojknockout', 'promise', 'ojs/ojlistview',
    ...
    function(oj, ko, $) {
        ...
        function CustomerViewModel() {
            ...
            filterFunc['apple'] = function(model) { return (model.get('supplier').indexOf('Apple') > -1); };
            filterFunc['dell'] = function(model) { return (model.get('supplier').indexOf('Dell') > -1); };
            filterFunc['lenovo'] = function(model) { return (model.get('supplier').indexOf('Lenovo') > -1); };
            filterFunc['hp'] = function(model) { return (model.get('supplier').indexOf('HP') > -1); };
            filterFunc['epson'] = function(model) { return (model.get('supplier').indexOf('EPSON') > -1); };
            filterFunc['tc'] = function(model) { return (model.get('supplier').indexOf('Touchlitt3') > -1); };
            filterFunc['md'] = function(model) { return (model.get('supplier').indexOf('M&D') > -1); };
